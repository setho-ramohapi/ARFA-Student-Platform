...
<div id="side-menu" class="sidebar" style="width: 250px">
	...
	margin-top: 0;
	">
	<h2 style="font-size: 30px; color: blue;">Navigate to forums by module</h2>
...
<tr>
			...
			<td>
					...
					<a style="width: 300px;" class="btn btn-sm btn-outline-primary edit_quiz" href="./student-forums.php?uid=<?php echo $uid?>&pid=<?php echo $pid?>"><i class="fa fa-task">
					Open <?php echo $aname?> forums</a>
