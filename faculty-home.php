...
<div id="side-menu" class="sidebar">
	...
	<hr style="border: 1px solid transparent;">
		<div class="w3-content w3-section" id= "container1"  style="background: white; height: 25%; width: 65%; margin: 0; position: fixed; padding-top:0; border:; margin-bottom: 0px;">
...
while($row= $qry->fetch_assoc())
		{
			echo '
			<img class="mySlides" src="'.$row['IMG'].'" alt="logo" style="width: 85%; padding: 0; height: 100%; margin-top: -18px; margin-left: 75px;  margin-right: -3px; margin-bottom: 0; border: 1px solid green ;"/>';
		...
		<div class="display" id="main" style="border: ; margin-top:160px; position: relative;">
		<div class="grid-container">
		
		<div class="box" ><a href="staff-courses.php"><center>Programs</center><img src="resources.png" style="margin-top: 25px;" width="100%" height="70%" alt="logo" /></a></div>
		<div class="box" ><a href="staff-unit-listing-assignments.php"><center>Assignments</center><img src="assign.png" style="margin-top: 0px;" width="100%" height="85%" alt="logo" /></a></div>
		<div class="box" ><a href="staff-sessions.php"><center>Sessions</center><img src="sessions.png" style="margin-top: 15px;" width="100%" height="70%" alt="logo" /></a></div>
		<div class="box" ><a href="staff-forums.php?"><center>Forums</center><img src="forum.png" style="margin-top: 15px;" width="100%" height="70%" alt="logo" /></a></div><br>
		</div>
	</div>
