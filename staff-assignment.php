...
<div id="ass-blocks">
		...
		<?php
			...
			while($stmt->fetch()) {
						...
						echo 'Title: <a href="download.php?file=assignments\\'.$aname.'"<h2>'.$aname.'</h2></a><br>';
				echo 'Instructions: '.$txt.'<br>';
				echo 'Due date: '.$due.'<br>';
				 
				
				echo '<form style="float: left;"  action="delete-assignement.php" method="post">
		<table>
		<tr><td><input type="hidden" value="'.$aid.'" name="aid"></td></tr>
		<tr><td><input type="submit" value="Remove" /></p></td></tr>
		</table>
		</form>
		<form style="float: left;" action="close-assignment.php" method="post">
		<table>
		<tr><td><input type="hidden" value="'.$aid.'" name="aid"></td></tr>
		<tr><td><input type="submit" value="Close" /></p></td></tr>
		</table>
		</form>
		<form style="float: left;" enctype="multipart/form-data" method="post">
		<table>
		<tr><td><input type="hidden" value="'.$aid.'" name="aid"></td></tr>
		<tr><td><input type="submit" value="Edit" /></p></td></tr>
		</table>
		</form>';
