...
<li><a href="student-sessions.php">Sessions</a></li>
	...
	<div style="">
         ...
         <textarea name="post_text" rows=13 cols=100 wrap=virtual></textarea>
...
</form<div class="popup" onclick="func()"><p style="font-size: 18px;color:;font-weight: 700;border: none;">'.$name.' '.$surname.'</p>
